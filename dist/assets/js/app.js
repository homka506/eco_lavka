...
(function (factory) {
  ...
  var VERSION = "13.1.5"; //region Helper Methods
...
var praceSlider = document.getElementById('price-range');

if (praceSlider !== null) {
  //On change inputs mave slider
  var updatePriceSlider = function updatePriceSlider() {
    var min = priceInputs.min.val();
    var max = priceInputs.max.val();
    praceSlider.noUiSlider.set([min, max]);
  };

  //Create range slider only if element exist
  var priceInputs = {
    min: jquery__WEBPACK_IMPORTED_MODULE_0___default()('[name="price_min"]'),
    max: jquery__WEBPACK_IMPORTED_MODULE_0___default()('[name="price_max"]')
  };
  nouislider__WEBPACK_IMPORTED_MODULE_4___default.a.create(praceSlider, {
  ...
  praceSlider.noUiSlider.on('update', function (values) {
...
/* harmony import */ var foundation_sites_js_foundation_toggler__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! foundation-sites/js/foundation.toggler */ "./node_modules/foundation-sites/js/foundation.toggler.js");
...
foundation_sites_js_foundation_core__WEBPACK_IMPORTED_MODULE_1__["Foundation"].Motion = foundation_sites_js_foundation_util_motion__WEBPACK_IMPORTED_MODULE_5__["Motion"]; // Foundation.Move = Move;
...
foundation_sites_js_foundation_core__WEBPACK_IMPORTED_MODULE_1__["Foundation"].plugin(foundation_sites_js_foundation_toggler__WEBPACK_IMPORTED_MODULE_9__["Toggler"], 'Toggler'); // Foundation.plugin(Tooltip, 'Tooltip');
...
module.exports = __webpack_require__(/*! C:\Front-end\39\eco-lavka\src\assets\js\app.js */"./src/assets/js/app.js");
